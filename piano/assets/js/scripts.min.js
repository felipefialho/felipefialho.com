...
},refreshBuffer=function(obj,loop,id){var node=obj._nodeById(id);node.bufferSource=ctx.createBufferSource(),node.bufferSource.buffer=cache[obj._src],node.bufferSource.connect(node.panner),node.bufferSource.loop=loop[0],loop[0]&&(node.bufferSource.loopStart=loop[1],node.bufferSource.loopEnd=loop[1]+loop[2]),node.bufferSource.playbackRate.value=obj._rate};"function"==typeof define&&define.amd&&define(function(){return{Howler:Howler,Howl:Howl}}),window.Howler=Howler,window.Howl=Howl}(),function($){var notes={"1C":new Howl({urls:["assets/midia/1C.ogg"]}),"1Cs":new Howl({urls:["assets/midia/1Cs.ogg"]}),"1D":new Howl({urls:["assets/midia/1D.ogg"]}),"1Ds":new Howl({urls:["assets/midia/1Ds.ogg"]}),"1E":new Howl({urls:["assets/midia/1E.ogg"]}),"1F":new Howl({urls:["assets/midia/1F.ogg"]}),"1Fs":new Howl({urls:["assets/midia/1Fs.ogg"]}),"1G":new Howl({urls:["assets/midia/1G.ogg"]}),"1Gs":new Howl({urls:["assets/midia/1Gs.ogg"]}),"2A":new Howl({urls:["assets/midia/2A.ogg"]}),"2As":new Howl({urls:["assets/midia/2As.ogg"]}),"2B":new Howl({urls:["assets/midia/2B.ogg"]}),"2C":new Howl({urls:["assets/midia/2C.ogg"]}),"2Cs":new Howl({urls:["assets/midia/2Cs.ogg"]}),"2D":new Howl({urls:["assets/midia/2D.ogg"]}),"2Ds":new Howl({urls:["assets/midia/2Ds.ogg"]}),"2E":new Howl({urls:["assets/midia/2E.ogg"]}),"2F":new Howl({urls:["assets/midia/2F.ogg"]}),"2Fs":new Howl({urls:["assets/midia/2Fs.ogg"]}),"2G":new Howl({urls:["assets/midia/2G.ogg"]}),"2Gs":new Howl({urls:["assets/midia/2Gs.ogg"]}),"3A":new Howl({urls:["assets/midia/3A.ogg"]}),"3As":new Howl({urls:["assets/midia/3As.ogg"]}),"3B":new Howl({urls:["assets/midia/3B.ogg"]})},lockEvent={};$(".piano").bind("selectstart dragstart",function(ev){return ev.preventDefault(),!1}),$(window).bind("keydown",function(ev){console.log(ev.which)}),$(window).bind("keydown keyup",function(ev){var keyNo=ev.which,$key=$('[data-key="'+keyNo+'"]'),note=$key.attr("data-note");"keydown"==ev.type?(lockEvent[keyNo]=!0,$key.addClass("active"),$key.parent().addClass("active")):"keyup"==ev.type&&(lockEvent[keyNo]=!1,$key.removeClass("active"),$key.parent().removeClass("active")),lockEvent[keyNo]||notes[note].play()}),$(".key > span").mousedown(function(){var me=$(this),noteClick=me.attr("data-note");notes[noteClick].play()})}(jQuery);