...
},refreshBuffer=function(obj,loop,id){var node=obj._nodeById(id);node.bufferSource=ctx.createBufferSource(),node.bufferSource.buffer=cache[obj._src],node.bufferSource.connect(node.panner),node.bufferSource.loop=loop[0],loop[0]&&(node.bufferSource.loopStart=loop[1],node.bufferSource.loopEnd=loop[1]+loop[2]),node.bufferSource.playbackRate.value=obj._rate};"function"==typeof define&&define.amd&&define(function(){return{Howler:Howler,Howl:Howl}}),window.Howler=Howler,window.Howl=Howl}(),function($){var notes={"1C":new Howl({urls:["assets/midia/1C.mp3"]}),"1Cs":new Howl({urls:["assets/midia/1Cs.mp3"]}),"1D":new Howl({urls:["assets/midia/1D.mp3"]}),"1Ds":new Howl({urls:["assets/midia/1Ds.mp3"]}),"1E":new Howl({urls:["assets/midia/1E.mp3"]}),"1F":new Howl({urls:["assets/midia/1F.mp3"]}),"1Fs":new Howl({urls:["assets/midia/1Fs.mp3"]}),"1G":new Howl({urls:["assets/midia/1G.mp3"]}),"1Gs":new Howl({urls:["assets/midia/1Gs.mp3"]}),"2A":new Howl({urls:["assets/midia/2A.mp3"]}),"2As":new Howl({urls:["assets/midia/2As.mp3"]}),"2B":new Howl({urls:["assets/midia/2B.mp3"]}),"2C":new Howl({urls:["assets/midia/2C.mp3"]}),"2Cs":new Howl({urls:["assets/midia/2Cs.mp3"]}),"2D":new Howl({urls:["assets/midia/2D.mp3"]}),"2Ds":new Howl({urls:["assets/midia/2Ds.mp3"]}),"2E":new Howl({urls:["assets/midia/2E.mp3"]}),"2F":new Howl({urls:["assets/midia/2F.mp3"]}),"2Fs":new Howl({urls:["assets/midia/2Fs.mp3"]}),"2G":new Howl({urls:["assets/midia/2G.mp3"]}),"2Gs":new Howl({urls:["assets/midia/2Gs.mp3"]}),"3A":new Howl({urls:["assets/midia/3A.mp3"]}),"3As":new Howl({urls:["assets/midia/3As.mp3"]}),"3B":new Howl({urls:["assets/midia/3B.mp3"]})},lockEvent={};$(".piano").bind("selectstart dragstart",function(ev){return ev.preventDefault(),!1}),$(window).bind("keydown keyup",function(ev){var keyNo=ev.which,$key=$('[data-key="'+keyNo+'"]'),note=$key.attr("data-note");note&&("keydown"==ev.type?lockEvent[keyNo]||(notes[note].play(),lockEvent[keyNo]=!0,$key.addClass("active"),$key.parent().addClass("active")):"keyup"==ev.type&&(lockEvent[keyNo]=!1,$key.removeClass("active"),$key.parent().removeClass("active")))}),$(".key > span").mousedown(function(){var me=$(this),noteClick=me.attr("data-note");notes[noteClick].play()})}(jQuery);